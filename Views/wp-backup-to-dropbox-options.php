...
<p class="description"><?php printf( __( 'Version %s', 'wpbtd' ), BACKUP_TO_DROPBOX_VERSION ) ?></p>
	...
	<table class="form-table">
		...
		<tr valign="top">
			...
			<td>
				...
				<span class="description"><?php _e( 'Default is', 'wpbtd' ); ?><code><?php echo defined( 'WP_CONTENT_DIR' ) && WP_CONTENT_DIR ? basename( WP_CONTENT_DIR ) : 'wp-content'; ?>/backups</code></span>
	...
	echo '<h3>' . __( 'There was a fatal error loading WordPress Backup to Dropbox', 'wpbtd' ) . '</h3>';
