...
require_once '../class-file-list.php';
...
class File_List_Test extends PHPUnit_Framework_TestCase {
    ...
    public function testSetFileListFile() {
        ...
        $list = array(
	        array( "$dir/Out/", WP_Backup::PARTIAL ),
	        array( "$dir/class-wp-backup-test.php", WP_Backup::EXCLUDED )
        );
    ...
    public function testGet_exclude_state() {
        ...
        $list[7][1] = WP_Backup::EXCLUDED; //class-wp-backup-test.php
        $list[4][1] = WP_Backup::PARTIAL; //out/
        ...
        $this->assertEquals( WP_Backup::INCLUDED, $this->object->get_file_state( "$dir/Mocks/mock-wp-functions.php" ) );
        $this->assertEquals( WP_Backup::EXCLUDED, $this->object->get_file_state( "$dir/class-wp-backup-test.php" ) );
        $this->assertEquals( WP_Backup::PARTIAL, $this->object->get_file_state( "$dir/Out/" ) );
        ...
        $this->assertEquals( WP_Backup::EXCLUDED, $this->object->get_file_state( "$dir/Out/" ) );
        $this->assertEquals( WP_Backup::EXCLUDED, $this->object->get_file_state( "$dir/Out/expected.sql" ) );
        $this->assertEquals( WP_Backup::EXCLUDED, $this->object->get_file_state( "$dir/Out/Level1/" ) );
        $this->assertEquals( WP_Backup::EXCLUDED, $this->object->get_file_state( "$dir/Out/Level1/file.txt" ) );
        $this->assertEquals( WP_Backup::EXCLUDED, $this->object->get_file_state( "$dir/Out/Level1/Level2/" ) );
        $this->assertEquals( WP_Backup::EXCLUDED, $this->object->get_file_state( "$dir/Out/Level1/Level2/file.txt" ) );

        $this->create_file( "$dir/Out/Level1/file2.txt" );

        $this->assertEquals( WP_Backup::EXCLUDED, $this->object->get_file_state( "$dir/Out/Level1/file2.txt" ) );
	    $this->object->save();
        ...
        //If just a directory is set to INCLUDE or EXCLUDE then all of its sub files need to be updated accordingly
        $list[4][1] = WP_Backup::PARTIAL; //0ut/
	    $list[5][1] = WP_Backup::PARTIAL; //0ut/Level1/
	    $list[6][1] = WP_Backup::EXCLUDED; //0ut/Level1/Level2
        ...
        $this->assertEquals( WP_Backup::PARTIAL, $this->object->get_file_state( "$dir/Out/" ) );
        $this->assertEquals( WP_Backup::INCLUDED, $this->object->get_file_state( "$dir/Out/expected.sql" ) );
        $this->assertEquals( WP_Backup::PARTIAL, $this->object->get_file_state( "$dir/Out/Level1/" ) );
        $this->assertEquals( WP_Backup::INCLUDED, $this->object->get_file_state( "$dir/Out/Level1/file.txt" ) );
        $this->assertEquals( WP_Backup::EXCLUDED, $this->object->get_file_state( "$dir/Out/Level1/Level2/" ) );
        $this->assertEquals( WP_Backup::EXCLUDED, $this->object->get_file_state( "$dir/Out/Level1/Level2/file.txt" ) );
    }
    ...
    public function testGet_exclude_state2() {
        ...
        $this->assertEquals( WP_Backup::INCLUDED, $this->object->get_file_state( "$dir/Out/Level1/file2.txt" ) );

        $list = get_option( 'backup-to-dropbox-file-list' );
        $list[5][1] = WP_Backup::PARTIAL; //Out/Level1/
        $json = json_encode( $list );
        $this->object->set_file_list( $json );
